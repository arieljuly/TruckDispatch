    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Edit Fuel Type</h1>
                    <p class="mt-1 text-sm text-gray-600">Update fuel type information</p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Update the details for this fuel type</p>
                </div>

                <div class="p-6">
                    <form wire:submit.prevent="updateFuel">
